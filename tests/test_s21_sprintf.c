...
START_TEST(sprintf_2_signed) {
  char str1[200];
  char str2[200];
  char *str3 = "%0d Test %0.d Test %0.0d TEST %0d AAA %.d";
  int val = -3015;
  int val2 = -712;
  int val3 = -99;
  int val4 = -2939;
...
START_TEST(n_specifier) {
  ...
  char str2[1024];
  int ret = 0;
  char *format = "Hello, my dear friend %n";
...
START_TEST(test_sprintf_string_null_2) {
  char str1[200];
  char str2[200];
...
START_TEST(test_sprintf_2_c) {
  char str1[100];
  char str2[100];
  char *str3 =
      "%+010.5c Test % +10.5c Test %-10lc Test %-10lc Test %+10lc Test "
      "%+-#10lc";
  char a = 92;
  unsigned long int b = 92;
  unsigned long int c = 92;
  ck_assert_int_eq(sprintf(str1, str3, a, a, b, c, c, a),
                   s21_sprintf(str2, str3, a, a, b, c, c, a));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
...
// START_TEST(wide_str_ru) {
//   char str1[1024];
//   char str2[1024];

//   char *format = "Мальчик, %s нам принеси";
//   wchar_t w[] = L"водочки";
//   int a = s21_sprintf(str1, format, w);
//   int b = sprintf(str2, format, w);
//   ck_assert_str_eq(str1, str2);
...
Suite *test_s21_sprintf(void) {
  ...
  tcase_add_test(tc, test_sprintf_1_f);
  tcase_add_test(tc, test_sprintf_1_e);
  tcase_add_test(tc, test_sprintf_2_e);
  ...
  tcase_add_test(tc, test_sprintf_string_null);
  tcase_add_test(tc, test_sprintf_string_null_2);
  ...
  tcase_add_test(tc, test_sprintf_1_c);
  tcase_add_test(tc, test_sprintf_2_c);
